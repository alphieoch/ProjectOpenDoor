...
export default function SettingsPage() {
  ...
  useEffect(() => {
    fetch("/api/settings/sso")
      .then((r) => r.json())
      .then((data) => { setSettings(data.org || null); setLoading(false); })
    ...
    <div>
      ...
      <div className="flex gap-8">
        ...
        <div className="flex-1 min-w-0">
          ...
          {!loading && !settings && (
            <div className="alert-error">Failed to load settings.</div>
          )}
            ...
            <>
              ...
              {activeTab === "sso" && (
                <form onSubmit={saveSSO}>
                  <div className="card">
                    ...
                    <div className="flex items-center gap-3 px-6 py-4" style={{ borderTop: "1px solid var(--line)" }}>
              ...
              {activeTab === "domain" && (
                <div className="card">
                  ...
                  <div className="divide-y px-6" style={{ borderColor: "var(--line)" }}>
                    <SettingRow label="Dashboard CNAME" hint="Point your dashboard subdomain here.">
              ...
              {activeTab === "email" && (
                <div className="card">
                  <div className="px-6 py-4" style={{ borderBottom: "1px solid var(--line)" }}>
                    ...
                    <p className="mt-1 text-sm" style={{ color: "var(--ink-3)" }}>
                      Invitation and alert emails are sent via Azure Communication Services.
                    </p>
                  </div>
                  ...
                  <div className="divide-y px-6" style={{ borderColor: "var(--line)" }}>
                    <SettingRow label="Status">
                      <div className="alert-warning text-xs">
                        Email is in console-only mode. Set the Azure Communication Services connection string to enable real delivery.
                      </div>
                    </SettingRow>

                    <SettingRow label="Required variables" hint="Add these to your deployment environment.">
