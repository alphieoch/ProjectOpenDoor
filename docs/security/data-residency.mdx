...
description: "OpenDoor is deployed across multiple Azure regions. Data residency controls let you specify where request payloads, logs, and fine-tuning data are physically stored and processed."
---
