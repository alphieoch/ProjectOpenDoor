---
title: "Run locally"
description: "Start the gateway and dashboard, preview docs.page, and make a real chat call."
---
...
# Terminal 3 — these docs (optional)
bun run docs:dev
```

`docs:dev` runs [`@docs.page/cli preview`](https://use.docs.page/features/local-preview). It opens a preview URL on docs.page that streams this repo’s `docs/` over a local WebSocket. After you push to the public GitHub repo, anyone can read [docs.page/alphieoch/ProjectOpenDoor](https://docs.page/alphieoch/ProjectOpenDoor) without running a docs container.
...
| Docs (published) | https://docs.page/alphieoch/ProjectOpenDoor | This site |
